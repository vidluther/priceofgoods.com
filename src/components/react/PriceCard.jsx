...
export default function PriceCard({ item, loading, error }) {
  ...
  return (
    <a href={`/${slugify(item.name)}`} className="block group">
      <div
        className={`relative overflow-hidden rounded-lg ${item.bgColor} shadow transition group-hover:shadow-lg group-hover:scale-[1.02] transform duration-200`}
      >
        <div className="p-6">
              ...
              <>
                ...
                {item.priceChange !== null && (
                  <div className="mt-2 flex items-center">
                    ...
                    <span
                      className={`ml-1 ${getChangeColor(item.priceChange)}`}
                    >
